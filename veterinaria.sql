CREATE DATABASE IF NOT EXISTS `veterinaria2`
...
VALUES (
  ...
  (103, 9, 9, 1, '2026-02-02 11:15:00', ''),
  (104, 9, 15, 1, '2026-02-02 11:30:00', ''),
  (105, 8, 9, 1, '2026-02-03 11:30:00', ''),
  (106, 17, 9, 1, '2026-02-02 08:45:00', ''),
  (107, 2, 1, 6, '2026-01-29 17:00:00', ''),
  (108, 8, 1, 6, '2026-01-29 16:15:00', ''),
  (109, 19, 9, 1, '2026-01-28 15:30:00', 'Hola'),
  (110, 17, 15, 1, '2026-01-28 15:00:00', ''),
  (
    111,
    17,
    1,
  ...
  (125, 11, 10, 1, '2026-02-25 11:00:00', ''),
  (
    126,
    15,
    9,
  ...
  (128, 11, 19, 202, '2026-02-19 16:15:00', '');
...
VALUES (1, 'Lun', '08:00:00', '18:00:00'),
  ...
  (50, 'Lun', '08:00:00', '13:00:00'),
  (50, 'Mar', '08:00:00', '13:00:00'),
  (50, 'Mie', '14:00:00', '19:00:00'),
  (50, 'Sab', '09:00:00', '13:00:00'),
  (50, 'Vie', '08:00:00', '13:00:00'),
  (51, 'Dom', '10:00:00', '14:00:00'),
  (51, 'Jue', '15:00:00', '20:00:00'),
  (51, 'Mar', '15:00:00', '20:00:00'),
  (51, 'Vie', '08:00:00', '14:00:00'),
  (58, 'Dom', '18:00:00', '20:00:00'),
  (59, 'Sáb', '18:00:00', '19:00:00'),
  (61, 'Jue', '17:00:00', '19:00:00'),
  (201, 'Lun', '08:00:00', '12:00:00'),
  (201, 'Mie', '08:00:00', '12:00:00'),
  (201, 'Vie', '08:00:00', '12:00:00'),
  (202, 'Jue', '14:00:00', '18:00:00'),
  (202, 'Mar', '14:00:00', '18:00:00'),
  (203, 'Lun', '09:00:00', '13:00:00'),
  (203, 'Mar', '09:00:00', '13:00:00'),
  (204, 'Mie', '15:00:00', '20:00:00'),
  (204, 'Vie', '15:00:00', '20:00:00'),
  (205, 'Jue', '08:00:00', '12:00:00'),
  (205, 'Lun', '08:00:00', '12:00:00'),
  (206, 'Mar', '10:00:00', '16:00:00'),
  (206, 'Mie', '10:00:00', '16:00:00'),
  (207, 'Lun', '14:00:00', '19:00:00'),
  (207, 'Vie', '14:00:00', '19:00:00'),
  (208, 'Jue', '08:00:00', '12:00:00'),
  (208, 'Mar', '08:00:00', '12:00:00'),
  (209, 'Mie', '09:00:00', '14:00:00'),
  (209, 'Sab', '09:00:00', '13:00:00'),
  (210, 'Jue', '16:00:00', '20:00:00'),
  (210, 'Lun', '16:00:00', '20:00:00'),
  (211, 'Mar', '19:00:00', '20:00:00'),
  (213, 'Lun', '08:00:00', '17:00:00'),
  (214, 'Mar', '17:00:00', '20:00:00');
...
VALUES (1, 'Control de corazon', 9, 5000.00),
  (8, 'Ecografia del corazon', 9, 7500.00),
  (9, 'Cirugia de rodilla', 5, 15000.00),
  (10, 'Curación de heridas', 5, 2500.00),
  (15, 'Radiografia', 5, 6000.00),
  (18, 'Corte de pelo', 3, 1500.00),
  (19, 'Vacunación Antirrábica', 4, 2500.00),
  (20, 'Cirugía de Tejidos Blandos', 8, 150000.00),
  (21, 'Esterilización / Castración', 8, 45000.00),
  (22, 'Test de Alergia', 10, 35000.00),
  (23, 'Tratamiento de Otitis', 10, 18000.00),
  (24, 'Biopsia de Piel', 10, 25000.00),
  (25, 'Consulta General', 7, 12000.00),
  (26, 'Análisis de Sangre Completo', 7, 15500.00),
  (27, 'Baño Medicado', 3, 15000.00),
  (28, 'Corte de Uñas e Higiene', 3, 8000.00),
  (29, 'Fisioterapia y Rehabilitación', 5, 12000.00),
  (30, 'Vendaje Funcional / Férula', 5, 9500.00),
  (31, 'Infiltración Articular', 5, 22000.00),
  (32, 'Plan de descenso de peso', 11, 15000.00),
  (
    33,
    'Diseño de dieta natural (BARF)',
    11,
    20000.00
  ),
  (34, 'Test de Schirmer (Lagrimeo)', 12, 8500.00),
  (35, 'Cirugía de Cataratas', 12, 180000.00),
  (
    36,
  ...
  (38, 'Extracción dental simple', 13, 15000.00),
  (
    39,
    'Nebulización / Terapia respiratoria',
    7,
    7500.00
  ),
  (40, 'Colocación de microchip ID', 7, 25000.00),
  (
    41,
    'Tratamiento para Sarna / Ácaros',
    10,
    18500.00
  ),
  (42, 'Baño antiséptico profesional', 10, 12000.00),
  (43, 'Ecografía Musculoesquelética', 5, 18500.00),
  (44, 'Cirugía de Columna (Hernias)', 5, 250000.00),
  (45, 'Corte de Raza Específico', 3, 18000.00),
  (47, 'Desenredado Manual (por hora)', 3, 7000.00),
  (50, 'Lavado Gástrico', 7, 28000.00),
  (51, 'Sondaje Uretral', 7, 12000.00),
  (52, 'Oxigenoterapia (por hora)', 7, 9000.00),
  (
    53,
  ...
  (54, 'Vacuna Quíntuple / Séxtuple', 4, 14500.00),
  (57, 'Cirugía de Oído (Ablación)', 8, 85000.00),
  (
    60,
  ...
  (61, 'Sutura de Herida Profunda', 8, 15500.00),
  (62, 'Holter de 24 horas', 9, 45000.00),
  (63, 'Electrocardiograma (ECG)', 9, 12000.00),
  (
    64,
    'Lámpara de Wood (Detección Hongos)',
    10,
    6500.00
  ),
  (
    65,
    'Tratamiento de Alergias Crónicas',
    10,
    22000.00
  ),
  (66, 'Limpieza de Oídos Profunda', 10, 9500.00);
